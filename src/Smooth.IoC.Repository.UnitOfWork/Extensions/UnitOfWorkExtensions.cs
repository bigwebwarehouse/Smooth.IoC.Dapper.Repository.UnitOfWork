...
namespace Smooth.IoC.Repository.UnitOfWork.Extensions
{
    public static class UnitOfWorkExtensions
    {
            ...
            Action<IConditionalBulkSqlStatementOptionsBuilder<TEntity>> statementOptions = null) where TEntity : class
        {
            ...
            if (statementOptions is null)
                return uow.Connection.BulkDeleteAsync<TEntity>(statement => statement.AttachToTransaction(uow.Transaction));
            ...
            Action<IConditionalBulkSqlStatementOptionsBuilder<TEntity>> statementOptions = null) where TEntity : class
        {
            ...
            if (statementOptions is null)
                return uow.Connection.BulkUpdate(updateData, statement => statement.AttachToTransaction(uow.Transaction));
            ...
            Action<IConditionalBulkSqlStatementOptionsBuilder<TEntity>> statementOptions = null) where TEntity : class
        {
            ...
            if (statementOptions is null)
                return uow.Connection.BulkUpdateAsync(updateData, statement => statement.AttachToTransaction(uow.Transaction));
            ...
            Action<IStandardSqlStatementOptionsBuilder<TEntity>> statementOptions = null) where TEntity : class
        {
            ...
            if (statementOptions is null)
                return uow.Connection.Delete(entityToDelete, statement => statement.AttachToTransaction(uow.Transaction));
            ...
            Action<IStandardSqlStatementOptionsBuilder<TEntity>> statementOptions = null) where TEntity : class
        {
            ...
            if (statementOptions is null)
                return uow.Connection.DeleteAsync(entityToDelete, statement => statement.AttachToTransaction(uow.Transaction));
            ...
            Action<IStandardSqlStatementOptionsBuilder<TEntity>> statementOptions = null) where TEntity : class
        {
            ...
            if (statementOptions is null)
                return uow.Connection.InsertAsync(entityToInsert, statement => statement.AttachToTransaction(uow.Transaction));
            ...
            Action<IStandardSqlStatementOptionsBuilder<TEntity>> statementOptions = null) where TEntity : class
        {
            ...
            if (statementOptions is null)
                return uow.Connection.Update(entityToUpdate, statement => statement.AttachToTransaction(uow.Transaction));
            ...
            Action<IStandardSqlStatementOptionsBuilder<TEntity>> statementOptions = null) where TEntity : class
        {
            ...
            if (statementOptions is null)
                return uow.Connection.UpdateAsync(entityToUpdate, statement => statement.AttachToTransaction(uow.Transaction));
